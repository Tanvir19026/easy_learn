...
public class admHuminity extends AppCompatActivity implements PaymentResultListener {
    private Button button;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_adm_huminity);
        Checkout.preload(getApplicationContext());

        button = findViewById(R.id.paymentbtnhum);
